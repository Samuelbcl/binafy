...
--
-- 84 paramètres : 69 confirmés à la source,
-- 11 règles légales en attente de vérification,
...
values
  ...
  ('notaire.achat.tranche_1.plafond', 2026, null, 7500, 'eur', 'Honoraires notaire — plafond tranche 1', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.achat.tranche_1.taux', 2026, null, 4.56, 'pourcent', 'Honoraires notaire — taux tranche 1', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.achat.tranche_2.plafond', 2026, null, 17500, 'eur', 'Honoraires notaire — plafond tranche 2', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.achat.tranche_2.taux', 2026, null, 2.85, 'pourcent', 'Honoraires notaire — taux tranche 2', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.achat.tranche_3.plafond', 2026, null, 30000, 'eur', 'Honoraires notaire — plafond tranche 3', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.achat.tranche_3.taux', 2026, null, 2.28, 'pourcent', 'Honoraires notaire — taux tranche 3', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.achat.tranche_4.plafond', 2026, null, 45495, 'eur', 'Honoraires notaire — plafond tranche 4', 'https://www.notaire.be', '2026-09-01', false, false),
  ('notaire.achat.tranche_4.taux', 2026, null, 1.71, 'pourcent', 'Honoraires notaire — taux tranche 4', 'https://www.notaire.be', '2026-09-01', false, false),
  ('notaire.achat.tranche_5.plafond', 2026, null, 64095, 'eur', 'Honoraires notaire — plafond tranche 5', 'https://www.notaire.be', '2026-09-01', false, false),
  ('notaire.achat.tranche_5.taux', 2026, null, 1.14, 'pourcent', 'Honoraires notaire — taux tranche 5', 'https://www.notaire.be', '2026-09-01', false, false),
  ('notaire.achat.tranche_6.plafond', 2026, null, 250095, 'eur', 'Honoraires notaire — plafond tranche 6', 'https://www.notaire.be', '2026-09-01', false, false),
  ('notaire.achat.tranche_6.taux', 2026, null, 0.57, 'pourcent', 'Honoraires notaire — taux tranche 6', 'https://www.notaire.be', '2026-09-01', false, false),
  ('notaire.achat.tranche_7.taux', 2026, null, 0.057, 'pourcent', 'Honoraires notaire — taux au-delà de la tranche 6', 'https://www.notaire.be', '2026-09-06', true, false),
  ('notaire.frais_debours', 2026, null, 1100, 'eur', 'Frais et débours administratifs forfaitaires (recherches, transcription)', 'https://www.notaire.be', '2026-09-01', false, false),
  ...
  ('credit.droit_hypotheque', 2026, null, 1, 'pourcent', 'Droit d''hypothèque sur le montant emprunté', 'https://finances.belgium.be/fr/particuliers/habitation/emprunt', '2026-09-01', false, false),
  ('credit.frais_acte_forfait', 2026, null, 2200, 'eur', 'Acte de crédit — honoraires, inscription hypothécaire et débours', 'https://www.notaire.be', '2026-09-01', false, false),
  ('credit.frais_dossier', 2026, null, 500, 'eur', 'Frais de dossier bancaire', 'https://www.nbb.be', '2026-09-01', false, true),
  ...
  ('credit.ratio_charge_max', 2026, null, 33, 'pourcent', 'Ratio de charge maximum usuel — mensualité sur revenus nets', 'https://www.nbb.be', '2026-09-01', false, true),
  ('credit.part_loyer_prise_en_compte', 2026, null, 75, 'pourcent', 'Part du loyer attendu prise en compte dans les revenus (locatif)', 'https://www.nbb.be', '2026-09-01', false, true),
  ...
  ('independant.cotisations_taux', 2026, null, 20.5, 'pourcent', 'Cotisations sociales — taux sur le revenu net imposable', 'https://www.rsvz-inasti.fgov.be', '2026-09-01', true, false),
  ('independant.seuil_cotisations_complementaire', 2026, null, 1922.16, 'eur', 'Indépendant complémentaire — seuil annuel de revenu net sous lequel aucune cotisation n’est due', 'https://www.rsvz-inasti.fgov.be', '2026-09-01', true, false),
  ...
  ('hypothese.taux_retrait_defaut', 2026, null, 4, 'pourcent', 'Taux de retrait annuel retenu par défaut', 'https://statbel.fgov.be', '2026-09-01', false, true)
