...
--
-- 76 paramètres, dont 57 confirmés à la source
-- et 19 en attente de vérification
...
values
  ...
  ('rc.coefficient_indexation', 2026, null, 2.3, 'coefficient', 'Revenu cadastral — coefficient d''indexation de l''année', 'https://www.securex.be/fr/lex4you/employeur/actualites/les-nouveaux-montants-fiscaux-indexes-pour-2026-c381d184ee6ae843ae2af770a61faa5e', '2026-09-06', true),
  ...
  ('droits_enregistrement.abattement', 2026, 'bruxelles', 200000, 'eur', 'Droits d''enregistrement — abattement sur la première tranche (Bruxelles)', 'https://www.notaire.be/immobilier/acheter-et-vendre-un-bien-immobilier/les-frais-lies-lachat/droits-denregistrement-reduction-et-abattement-bruxelles', '2026-09-06', true),
  ('droits_enregistrement.abattement_prix_max', 2026, 'bruxelles', 600000, 'eur', 'Abattement bruxellois — prix d''achat maximum pour en bénéficier', 'https://www.notaire.be/immobilier/acheter-et-vendre-un-bien-immobilier/les-frais-lies-lachat/droits-denregistrement-reduction-et-abattement-bruxelles', '2026-09-06', true),
  ...
  ('notaire.achat.tranche_1.plafond', 2026, null, 7500, 'eur', 'Honoraires notaire — plafond tranche 1', 'https://www.notaire.be', '2026-09-06', true),
  ('notaire.achat.tranche_1.taux', 2026, null, 4.56, 'pourcent', 'Honoraires notaire — taux tranche 1', 'https://www.notaire.be', '2026-09-06', true),
  ('notaire.achat.tranche_2.plafond', 2026, null, 17500, 'eur', 'Honoraires notaire — plafond tranche 2', 'https://www.notaire.be', '2026-09-06', true),
  ('notaire.achat.tranche_2.taux', 2026, null, 2.85, 'pourcent', 'Honoraires notaire — taux tranche 2', 'https://www.notaire.be', '2026-09-06', true),
  ('notaire.achat.tranche_3.plafond', 2026, null, 30000, 'eur', 'Honoraires notaire — plafond tranche 3', 'https://www.notaire.be', '2026-09-06', true),
  ('notaire.achat.tranche_3.taux', 2026, null, 2.28, 'pourcent', 'Honoraires notaire — taux tranche 3', 'https://www.notaire.be', '2026-09-06', true),
  ...
  ('notaire.achat.tranche_7.taux', 2026, null, 0.057, 'pourcent', 'Honoraires notaire — taux au-delà de la tranche 6', 'https://www.notaire.be', '2026-09-06', true),
  ...
  ('ipp.tranche_1.plafond', 2026, null, 16720, 'eur', 'IPP — plafond de la tranche à 25 %', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.tranche_1.taux', 2026, null, 25, 'pourcent', 'IPP — taux de la tranche 1', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.tranche_2.plafond', 2026, null, 29510, 'eur', 'IPP — plafond de la tranche à 40 %', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.tranche_2.taux', 2026, null, 40, 'pourcent', 'IPP — taux de la tranche 2', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.tranche_3.plafond', 2026, null, 51070, 'eur', 'IPP — plafond de la tranche à 45 %', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.tranche_3.taux', 2026, null, 45, 'pourcent', 'IPP — taux de la tranche 3', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.tranche_4.taux', 2026, null, 50, 'pourcent', 'IPP — taux marginal supérieur', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ('ipp.quotite_exemptee', 2026, null, 11180, 'eur', 'IPP — quotité de revenu exemptée d''impôt', 'https://fin.belgium.be/fr/particuliers/declaration_impot/taux-imposition-revenus/taux-imposition', '2026-09-06', true),
  ...
  ('epargne_pension.plafond_bas', 2026, null, 1050, 'eur', 'Épargne-pension — plafond bas de versement', 'https://fin.belgium.be/fr/particuliers/avantages_fiscaux/epargne-pension', '2026-09-06', true),
  ('epargne_pension.reduction_bas', 2026, null, 30, 'pourcent', 'Épargne-pension — taux de réduction d''impôt au plafond bas', 'https://fin.belgium.be/fr/particuliers/avantages_fiscaux/epargne-pension', '2026-09-06', true),
  ('epargne_pension.plafond_haut', 2026, null, 1350, 'eur', 'Épargne-pension — plafond haut de versement', 'https://fin.belgium.be/fr/particuliers/avantages_fiscaux/epargne-pension', '2026-09-06', true),
  ('epargne_pension.reduction_haut', 2026, null, 25, 'pourcent', 'Épargne-pension — taux de réduction d''impôt au plafond haut', 'https://fin.belgium.be/fr/particuliers/avantages_fiscaux/epargne-pension', '2026-09-06', true),
  ('epargne_pension.taxe_anticipative', 2026, null, 8, 'pourcent', 'Épargne-pension — taxe anticipative prélevée à 60 ans', 'https://www.wikifin.be/fr/pension-et-preparation-de-la-retraite/epargne-pension/comment-votre-epargne-pension-est-elle-taxee', '2026-09-06', true),
